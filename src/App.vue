<template>
  <div>
    ...
    <template v-if="this.question">
      ...
      <button v-if="!this.answerSubmitted" @click="submit()" class="send" type="button" :disabled="this.answerSubmitted">Send</button>
      <section v-if="this.answerSubmitted" class="result">
        ...
        <h4 v-else
            v-html="'&#10060; Sorry, you picked the wrong answer. The correct is ' + this.correctAnswer + '.'"
        >
        </h4>
